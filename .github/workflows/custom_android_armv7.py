...
archive_name_engine = 'dragengine-{ReleaseVersion}-android32'
archive_name_engine_dev = 'dragengine-dev-{ReleaseVersion}-android32'
archive_name_igde = 'deigde-{ReleaseVersion}-android32'
archive_name_igde_dev = 'deigde-dev-{ReleaseVersion}-android32'
archive_name_special = 'despecial-{ReleaseVersion}-android32'
installer_name_engine = 'install-dragengine-{ReleaseVersion}-android32'
installer_name_engine_dev = 'install-dragengine-dev-{ReleaseVersion}-android32'
installer_name_igde = 'install-deigde-{ReleaseVersion}-android32'
installer_name_igde_dev = 'install-deigde-dev-{ReleaseVersion}-android32'
