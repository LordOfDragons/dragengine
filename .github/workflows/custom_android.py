...
archive_name_engine_debug = 'dragengine-dbg-{ReleaseVersion}-android-{AndroidArch}'
...
archive_name_igde_debug = 'deigde-dbg-{ReleaseVersion}-android-{AndroidArch}'
archive_name_special = 'despecial-{ReleaseVersion}-android-{AndroidArch}'
archive_name_special_debug = 'despecial-dbg-{ReleaseVersion}-android-{AndroidArch}'
