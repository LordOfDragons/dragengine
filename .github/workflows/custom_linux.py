...
archive_name_engine_debug = 'dragengine-dbg-{ReleaseVersion}-linux64'
archive_name_igde = 'deigde-{ReleaseVersion}-linux64'
archive_name_igde_dev = 'deigde-dev-{ReleaseVersion}-linux64'
archive_name_igde_debug = 'deigde-dbg-{ReleaseVersion}-linux64'
archive_name_special = 'despecial-{ReleaseVersion}-linux64'
archive_name_special_debug = 'despecial-dbg-{ReleaseVersion}-linux64'
