...
with_system_libyuv = 'no'
with_system_libdav1d = 'no'
with_system_svtav1 = 'no'
with_system_libavif = 'no'
...
#########################
build_audio_openal = 'no'
build_cr_basic = 'no'
build_graphics_opengl = 'no'
build_image_png = 'yes'
...
archive_name_engine = 'dragengine-ci-{ReleaseVersion}-linux64'
archive_name_engine_dev = 'dragengine-ci-dev-{ReleaseVersion}-linux64'
archive_name_engine_debug = 'dragengine-ci-dbg-{ReleaseVersion}-linux64'
archive_name_igde = 'deigde-ci-{ReleaseVersion}-linux64'
archive_name_igde_dev = 'deigde-ci-dev-{ReleaseVersion}-linux64'
archive_name_igde_debug = 'deigde-ci-dbg-{ReleaseVersion}-linux64'
archive_name_special = 'despecial-ci-{ReleaseVersion}-linux64'
archive_name_special_debug = 'despecial-ci-dbg-{ReleaseVersion}-linux64'
installer_name_engine = 'install-dragengine-ci-{ReleaseVersion}-linux64'
installer_name_engine_dev = 'install-dragengine-ci-dev-{ReleaseVersion}-linux64'
installer_name_igde = 'install-deigde-ci-{ReleaseVersion}-linux64'
installer_name_igde_dev = 'install-deigde-ci-dev-{ReleaseVersion}-linux64'
addon_name_blender = 'blender-addon-dragengine-ci'
