...
if(!$InternalModule)
{
    $TargetDir = "$DistributeDir\$PathDistDEDataModules\crashrecovery\basicrecovery\$Version"
...
if(!$InternalModule)
{
    $TargetDir = "$DistributeDir\$PathDistDEPdbDataModules\crashrecovery\basicrecovery\$Version"
