...
if(!$InternalModule)
{
    $TargetDir = "$DistributeDir\$PathDistDEDataModules\synthesizer\desynthesizer\$Version"
...
if(!$InternalModule)
{
    $TargetDir = "$DistributeDir\$PathDistDEPdbDataModules\synthesizer\desynthesizer\$Version"
