...
$Library = Join-Path -Path $OutputDir -ChildPath "scrdragonscript.dll"
...
Install-Files -Path (Join-Path -Path $OutputDir -ChildPath "scrdragonscript.pdb") -Destination $TargetDir
