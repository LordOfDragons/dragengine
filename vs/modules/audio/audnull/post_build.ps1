...
$TargetDir = Join-Path -Path $OutputDir -ChildPath "Distribute\Dragengine\Application\@ProgramFiles\Dragengine\Data\modules\audio\null\$Version"
...
$FilePath = Join-Path -Path $OutputDir -ChildPath "audnull.pdb"
