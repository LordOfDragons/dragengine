...
$TargetDir = Join-Path -Path $OutputDir -ChildPath "Distribute\Dragengine\Application\@ProgramFiles\Dragengine\Data\modules\archive\delga\$Version"
...
$FilePath = Join-Path -Path $OutputDir -ChildPath "arcdelga.pdb"
