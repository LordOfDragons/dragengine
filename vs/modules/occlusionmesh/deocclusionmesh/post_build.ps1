...
if(!$InternalModule)
{
    $TargetDir = "$DistributeDir\$PathDistDEDataModules\occlusionmesh\deocclusionmesh\$Version"
...
if(!$InternalModule)
{
    $TargetDir = "$DistributeDir\$PathDistDEPdbDataModules\occlusionmesh\deocclusionmesh\$Version"
