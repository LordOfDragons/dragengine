...
$Library = Join-Path -Path $OutputDir -ChildPath "langpackdelangpack.dll"
...
Install-Files -Path (Join-Path -Path $OutputDir -ChildPath "langpackdelangpack.pdb") -Destination $TargetDir
