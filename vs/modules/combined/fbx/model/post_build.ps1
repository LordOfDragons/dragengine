...
$TargetDir = Join-Path -Path $OutputDir -ChildPath "Distribute\Dragengine\Application\@ProgramFiles\Dragengine\Data\modules\model\fbxmodel\$Version"
...
$FilePath = Join-Path -Path $OutputDir -ChildPath "mdlfbx.pdb"
