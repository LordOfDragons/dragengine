...
$TargetDir = Join-Path -Path $OutputDir -ChildPath "Distribute\Dragengine\Application\@ProgramFiles\Dragengine\Data\modules\font\defont\$Version"
...
$FilePath = Join-Path -Path $OutputDir -ChildPath "fontdefont.pdb"
