...
$TargetDir = Join-Path -Path $OutputDir -ChildPath "Distribute\Dragengine\Application\@ProgramFiles\Dragengine\Data\modules\animator\deanimator\$Version"
...
$FilePath = Join-Path -Path $OutputDir -ChildPath "anideanimator.pdb"
