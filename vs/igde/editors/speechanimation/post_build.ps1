...
$TargetDir = "$DistributeDir\$PathDistIGDEDataModules\speechanimation"
...
$DataTargetDir = "$DistributeDir\$PathDistIGDESharesModules\speechanimation"
...
# debug
$TargetDir = "$DistributeDir\$PathDistIGDEPdbDataModules\speechanimation"
