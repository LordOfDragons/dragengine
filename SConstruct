...
params.Add(TernaryVariable('with_system_libyuv', 'Use System libyuv'))
params.Add(TernaryVariable('with_system_libdav1d', 'Use System libdav1d'))
params.Add(TernaryVariable('with_system_svtav1', 'Use System SVT-AV1'))
params.Add(TernaryVariable('with_system_libwebp', 'Use System libwebp'))
params.Add(TernaryVariable('with_system_libavif', 'Use System libavif'))
...
params.Add(TernaryVariable('build_image_avif', 'Build AVIF Image Module'))
...
params.Add(TernaryVariable('build_image_avif', 'Build AVIF Image Module'))
params.Add(TernaryVariable('build_image_avif3d', 'Build AVIF Image Module'))
...
params.Add(BoolVariable('build_image_avif_internal', 'Build AVIF Image Module as internal module', True))
params.Add(BoolVariable('build_image_avif3d_internal', 'Build AVIF Image Module as internal module', True))
...
extdirs.append('extern/libyuv')
extdirs.append('extern/libdav1d')
extdirs.append('extern/svtav1')
extdirs.append('extern/libvpx')
extdirs.append('extern/libwebp')
extdirs.append('extern/libavif')
