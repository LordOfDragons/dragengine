...
params.Add(BoolVariable('build_ai_deai_internal', 'Build DEAI AI Module as internal module', True))
params.Add(BoolVariable('build_ani_deanimator_internal', 'Build DEAnimator Animator Module as internal module', True))
params.Add(BoolVariable('build_anim_deanim_internal', 'Build DEAnim Animation Module as internal module', True))
...
params.Add(BoolVariable('build_font_defont_internal', 'Build DEFont Font Module as internal module', True))
...
params.Add(BoolVariable('build_model_demodel_internal', 'Build DEModel Model Module as internal module', True))
params.Add(BoolVariable('build_network_basic_internal', 'Build Basic Network Module as internal module', True))
params.Add(BoolVariable('build_occmesh_deoccmesh_internal', 'Build DEOcclusionMesh Occlusion Mesh Module as internal module', True))
params.Add(BoolVariable('build_physics_bullet_internal', 'Build Bullet Physics Module as internal module', True))
params.Add(BoolVariable('build_rig_derig_internal', 'Build DERig Rig Module as internal module', True))
params.Add(BoolVariable('build_skin_deskin_internal', 'Build DESkin Skin Module as internal module', True))
