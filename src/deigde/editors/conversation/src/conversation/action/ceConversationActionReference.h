...
#ifndef _CECONVERSATIONACTIONREFERENCE_H_
#define _CECONVERSATIONACTIONREFERENCE_H_
...
/**
 * \brief Conversation action reference.
 * 
 ...
 */
class ceConversationActionReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	ceConversationActionReference();
	 ...
	 */
	ceConversationActionReference( ceConversationAction *object );
	 ...
	 */
	ceConversationActionReference( const ceConversationActionReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( ceConversationAction *object );
	...
	operator ceConversationAction*() const;
	 ...
	 * \throws deeNullPointer if object is \em NULL.
	 */
	ceConversationAction* operator->() const;
	 ...
	 */
	ceConversationActionReference &operator=( ceConversationAction *object );
	 ...
	 * stored. If the new object is not \em NULL a reference is added.
	 */
	ceConversationActionReference &operator=( const ceConversationActionReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( ceConversationAction *object ) const;
	bool operator!=( ceConversationAction *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const ceConversationActionReference &reference ) const;
	bool operator!=( const ceConversationActionReference &reference ) const;
	/*@}*/
};
