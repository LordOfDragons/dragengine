...
#ifndef _CECONVERSATIONCONDITIONREFERENCE_H_
#define _CECONVERSATIONCONDITIONREFERENCE_H_
...
/**
 * \brief Conversation condition reference.
 * 
 ...
 */
class ceConversationConditionReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	ceConversationConditionReference();
	 ...
	 */
	ceConversationConditionReference( ceConversationCondition *object );
	 ...
	 */
	ceConversationConditionReference( const ceConversationConditionReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( ceConversationCondition *object );
	...
	operator ceConversationCondition*() const;
	 ...
	 * \throws deeNullPointer if object is \em NULL.
	 */
	ceConversationCondition* operator->() const;
	 ...
	 */
	ceConversationConditionReference &operator=( ceConversationCondition *object );
	 ...
	 * stored. If the new object is not \em NULL a reference is added.
	 */
	ceConversationConditionReference &operator=( const ceConversationConditionReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( ceConversationCondition *object ) const;
	bool operator!=( ceConversationCondition *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const ceConversationConditionReference &reference ) const;
	bool operator!=( const ceConversationConditionReference &reference ) const;
	/*@}*/
};
