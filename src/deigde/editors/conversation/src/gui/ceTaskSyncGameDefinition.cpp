...
// Class ceTaskSyncGameDefinition
///////////////////////////////////
...
bool ceTaskSyncGameDefinition::Step(){
	...
	ceConversation &conversation = *pWindowMain.GetConversation();
	
	conversation.GetSky()->OnGameDefinitionChanged();
	conversation.GetEnvObject()->OnGameDefinitionChanged();
