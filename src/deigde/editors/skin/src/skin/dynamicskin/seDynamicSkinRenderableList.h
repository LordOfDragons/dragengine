...
#ifndef _SEDYNAMICSKINRENDERABLELIST_H_
#define _SEDYNAMICSKINRENDERABLELIST_H_
...
/**
 * @brief Dynamic Skin Renderable List.
 */
class seDynamicSkinRenderableList{
private:
	decObjectOrderedSet pRenderables;
	
public:
	/** @name Constructors and Destructors */
	/*@{*/
	/** Creates a new renderable list. */
	seDynamicSkinRenderableList();
	/** Cleans up the renderable list. */
	~seDynamicSkinRenderableList();
	/*@}*/
