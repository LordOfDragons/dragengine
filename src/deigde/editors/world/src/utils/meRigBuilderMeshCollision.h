...
#ifndef _MERIGBUILDERMESHCOLLISION_H_
#define _MERIGBUILDERMESHCOLLISION_H_
...
/**
 * \brief Mesh collision rig builder.
 */
class meRigBuilderMeshCollision : public deRigBuilder{
public:
