 ...
 * FOX Native button.
 */
class igdeNativeBeOSCheckBox : public BCheckBox{
public:
	enum eEvents{
		eeClicked = 'clic'
	};
...
public:
	...
	igdeNativeBeOSCheckBox( igdeCheckBox &owner, const igdeGuiTheme &guitheme );
	
	/** \brief Clean up native widget. */
	virtual ~igdeNativeBeOSCheckBox();
	...
	static BBitmap *CheckBoxIcon( const igdeCheckBox &owner );
