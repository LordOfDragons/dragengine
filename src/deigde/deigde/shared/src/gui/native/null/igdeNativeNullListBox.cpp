...
void igdeNativeNullListBox::PostCreateNativeWidget(){
}

void igdeNativeNullListBox::DestroyNativeWidget(){
	delete this;
}
...
void igdeNativeNullListBox::UpdateSelection(){
}
...
void igdeNativeNullListBox::UpdateRowCount(){
}

void igdeNativeNullListBox::UpdateDescription(){
}
