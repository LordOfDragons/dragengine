...
/**
 * \brief EditPathListener reference.
 * 
 ...
 */
class DE_DLL_EXPORT igdeEditPathListenerReference : protected deObjectReference{
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty edit point listener reference holder. */
	igdeEditPathListenerReference();
	 ...
	 */
	igdeEditPathListenerReference( igdeEditPathListener *listener );
	 ...
	 */
	igdeEditPathListenerReference( const igdeEditPathListenerReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( igdeEditPathListener *listener );
	...
	/** \brief Pather to edit point listener. */
	operator igdeEditPathListener*() const;
	
	/**
	 * \brief Reference to edit point listener.
	 * 
	 * \throws deeNullPather if edit point listener is NULL.
	 */
	operator igdeEditPathListener&() const;
	 ...
	 * \throws deeNullPather if edit point listener is NULL.
	 */
	igdeEditPathListener* operator->() const;
	 ...
	 */
	igdeEditPathListenerReference &operator=( igdeEditPathListener *listener );
	 ...
	 * stored. If the new edit point listener is not NULL a reference is added.
	 */
	igdeEditPathListenerReference &operator=( const igdeEditPathListenerReference &reference );
	
	/** \brief Test if edit point listener is held by this holder. */
	bool operator==( igdeEditPathListener *listener ) const;
	bool operator!=( igdeEditPathListener *listener ) const;
	
	/** \brief Test if edit point listener is held by this holder. */
	bool operator==( const igdeEditPathListenerReference &reference ) const;
	bool operator!=( const igdeEditPathListenerReference &reference ) const;
	/*@}*/
};
