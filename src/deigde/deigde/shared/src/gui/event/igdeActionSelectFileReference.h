...
#ifndef _IGDEACTIONSELECTFILEREFERENCE_H_
#define _IGDEACTIONSELECTFILEREFERENCE_H_
...
/**
 * \brief ActionSelectFile reference.
 * 
 ...
 */
class DE_DLL_EXPORT igdeActionSelectFileReference : protected deObjectReference{
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty action reference holder. */
	igdeActionSelectFileReference();
	 ...
	 */
	igdeActionSelectFileReference( igdeActionSelectFile *action );
	 ...
	 */
	igdeActionSelectFileReference( const igdeActionSelectFileReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( igdeActionSelectFile *action );
	...
	operator igdeActionSelectFile*() const;
	 ...
	 * \throws deeNullPointer if action is NULL.
	 */
	igdeActionSelectFile* operator->() const;
	 ...
	 */
	igdeActionSelectFileReference &operator=( igdeActionSelectFile *action );
	 ...
	 * stored. If the new action is not NULL a reference is added.
	 */
	igdeActionSelectFileReference &operator=( const igdeActionSelectFileReference &reference );
	
	/** \brief Test if action is held by this holder. */
	bool operator==( igdeActionSelectFile *action ) const;
	bool operator!=( igdeActionSelectFile *action ) const;
	
	/** \brief Test if action is held by this holder. */
	bool operator==( const igdeActionSelectFileReference &reference ) const;
	bool operator!=( const igdeActionSelectFileReference &reference ) const;
	/*@}*/
};
