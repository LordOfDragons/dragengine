...
#ifndef _IGDEICONLISTBOXLISTENERREFERENCE_H_
#define _IGDEICONLISTBOXLISTENERREFERENCE_H_
...
/**
 * \brief IconListBoxListener reference.
 * 
 ...
 */
class DE_DLL_EXPORT igdeIconListBoxListenerReference : protected deObjectReference{
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty listbox listener reference holder. */
	igdeIconListBoxListenerReference();
	 ...
	 */
	igdeIconListBoxListenerReference( igdeIconListBoxListener *listener );
	 ...
	 */
	igdeIconListBoxListenerReference( const igdeIconListBoxListenerReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( igdeIconListBoxListener *listener );
	...
	operator igdeIconListBoxListener*() const;
	 ...
	 * \throws deeNullPointer if listbox listener is NULL.
	 */
	igdeIconListBoxListener* operator->() const;
	 ...
	 */
	igdeIconListBoxListenerReference &operator=( igdeIconListBoxListener *listener );
	 ...
	 * stored. If the new listbox listener is not NULL a reference is added.
	 */
	igdeIconListBoxListenerReference &operator=( const igdeIconListBoxListenerReference &reference );
	
	/** \brief Test if listbox listener is held by this holder. */
	bool operator==( igdeIconListBoxListener *listener ) const;
	bool operator!=( igdeIconListBoxListener *listener ) const;
	
	/** \brief Test if listbox listener is held by this holder. */
	bool operator==( const igdeIconListBoxListenerReference &reference ) const;
	bool operator!=( const igdeIconListBoxListenerReference &reference ) const;
	/*@}*/
};
