...
#ifndef _IGDEWPCAMERAREFERENCE_H_
#define _IGDEWPCAMERAREFERENCE_H_
...
public:
	 ...
	 */
	igdeWPCameraReference( igdeWPCamera *widget );
	 ...
	 */
	igdeWPCameraReference( const igdeWPCameraReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( igdeWPCamera *widget );
	 ...
	 */
	igdeWPCameraReference &operator=( igdeWPCamera *widget );
	 ...
	 * stored. If the new widget is not NULL a reference is added.
	 */
	igdeWPCameraReference &operator=( const igdeWPCameraReference &reference );
	
	/** \brief Test if widget is held by this holder. */
	bool operator==( igdeWPCamera *widget ) const;
	bool operator!=( igdeWPCamera *widget ) const;
	
	/** \brief Test if widget is held by this holder. */
	bool operator==( const igdeWPCameraReference &reference ) const;
	bool operator!=( const igdeWPCameraReference &reference ) const;
	/*@}*/
};
