...
#ifndef _IGDEWPUNDOHISTORYREFERENCE_H_
#define _IGDEWPUNDOHISTORYREFERENCE_H_
...
/**
 * \brief Panel Undo History reference.
 * 
 ...
 */
class DE_DLL_EXPORT igdeWPUndoHistoryReference : protected deObjectReference{
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty widget reference holder. */
	igdeWPUndoHistoryReference();
	 ...
	 */
	igdeWPUndoHistoryReference( igdeWPUndoHistory *widget );
	 ...
	 */
	igdeWPUndoHistoryReference( const igdeWPUndoHistoryReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( igdeWPUndoHistory *widget );
	...
	operator igdeWPUndoHistory*() const;
	 ...
	 * \throws deeNullPointer if widget is NULL.
	 */
	igdeWPUndoHistory* operator->() const;
	 ...
	 */
	igdeWPUndoHistoryReference &operator=( igdeWPUndoHistory *widget );
	 ...
	 * stored. If the new widget is not NULL a reference is added.
	 */
	igdeWPUndoHistoryReference &operator=( const igdeWPUndoHistoryReference &reference );
	
	/** \brief Test if widget is held by this holder. */
	bool operator==( igdeWPUndoHistory *widget ) const;
	bool operator!=( igdeWPUndoHistory *widget ) const;
	
	/** \brief Test if widget is held by this holder. */
	bool operator==( const igdeWPUndoHistoryReference &reference ) const;
	bool operator!=( const igdeWPUndoHistoryReference &reference ) const;
	/*@}*/
};
