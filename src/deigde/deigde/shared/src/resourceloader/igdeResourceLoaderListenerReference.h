...
#ifndef _IGDERESOURCELOADERLISTENERREFERENCE_H_
#define _IGDERESOURCELOADERLISTENERREFERENCE_H_
...
/**
 * \brief ResourceLoaderListener reference.
 * 
 ...
 */
class DE_DLL_EXPORT igdeResourceLoaderListenerReference : protected deObjectReference{
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty listener reference holder. */
	igdeResourceLoaderListenerReference();
	 ...
	 */
	igdeResourceLoaderListenerReference( igdeResourceLoaderListener *listener );
	 ...
	 */
	igdeResourceLoaderListenerReference( const igdeResourceLoaderListenerReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( igdeResourceLoaderListener *listener );
	...
	operator igdeResourceLoaderListener*() const;
	 ...
	 * \throws deeNullPointer if listener is NULL.
	 */
	igdeResourceLoaderListener* operator->() const;
	 ...
	 */
	igdeResourceLoaderListenerReference &operator=( igdeResourceLoaderListener *listener );
	 ...
	 * stored. If the new listener is not NULL a reference is added.
	 */
	igdeResourceLoaderListenerReference &operator=( const igdeResourceLoaderListenerReference &reference );
	
	/** \brief Test if listener is held by this holder. */
	bool operator==( igdeResourceLoaderListener *listener ) const;
	bool operator!=( igdeResourceLoaderListener *listener ) const;
	
	/** \brief Test if listener is held by this holder. */
	bool operator==( const igdeResourceLoaderListenerReference &reference ) const;
	bool operator!=( const igdeResourceLoaderListenerReference &reference ) const;
	/*@}*/
};
