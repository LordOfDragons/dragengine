 ...
 */
class DE_DLL_EXPORT igdeGDPropertyReference : protected deObjectReference{
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty property reference holder. */
	igdeGDPropertyReference();
	 ...
	 */
	igdeGDPropertyReference( igdeGDProperty *property );
	 ...
	 */
	igdeGDPropertyReference( const igdeGDPropertyReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( igdeGDProperty *property );
	 ...
	 */
	igdeGDPropertyReference &operator=( igdeGDProperty *property );
	 ...
	 * stored. If the new property is not NULL a reference is added.
	 */
	igdeGDPropertyReference &operator=( const igdeGDPropertyReference &reference );
	
	/** \brief Test if property is held by this holder. */
	bool operator==( igdeGDProperty *property ) const;
	bool operator!=( igdeGDProperty *property ) const;
	
	/** \brief Test if property is held by this holder. */
	bool operator==( const igdeGDPropertyReference &reference ) const;
	bool operator!=( const igdeGDPropertyReference &reference ) const;
	/*@}*/
};
