...
igdeTriggerExpressionParserState::igdeTriggerExpressionParserState( const char *string ){
	...
	pString = string;
	pLength = pString.GetLength();
	pPosition = 0;
}

igdeTriggerExpressionParserState::~igdeTriggerExpressionParserState(){
}
...
bool igdeTriggerExpressionParserState::HasMoreCharacters() const{
