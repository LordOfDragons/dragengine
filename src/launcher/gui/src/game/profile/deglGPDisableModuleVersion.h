...
#ifndef _DEGLGPDISABLEMODULEVERSION_H_
#define _DEGLGPDISABLEMODULEVERSION_H_
 ...
 */
class deglGPDisableModuleVersion : public deObject{
private:
	decString pName;
	decString pVersion;
...
public:
	...
	deglGPDisableModuleVersion();
	deglGPDisableModuleVersion( const char *name, const char *version );
	/** \brief Create a copy of a game profile disable module version. */
	deglGPDisableModuleVersion( const deglGPDisableModuleVersion &copy );
	/** \brief Clean up the game profile disable module version. */
	virtual ~deglGPDisableModuleVersion();
	/*@}*/
	 ...
	 */
	bool operator==( const deglGPDisableModuleVersion &other ) const;
	/**
	...
	deglGPDisableModuleVersion &operator=( const deglGPDisableModuleVersion &other );
	/*@}*/
};
