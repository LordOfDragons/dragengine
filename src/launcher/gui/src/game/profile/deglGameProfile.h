...
#ifndef _DEGLGAMEPROFILE_H_
#define _DEGLGAMEPROFILE_H_
 ...
 * \brief Game Profile.
 */
class deglGameProfile : public deObject{
private:
	decString pName;
	...
	deglGPDisableModuleVersionList pDisableModuleVersionList;
	
	deglGPModuleList pModuleList;
...
public:
	...
	deglGameProfile( const char *name = "" );
	
	/** \brief Create a copy of a game profile. */
	deglGameProfile( const deglGameProfile &profile );
	
protected:
	/** \brief Clean up the game profile. */
	virtual ~deglGameProfile();
	/*@}*/
...
public:
	...
	inline deglGPDisableModuleVersionList &GetDisableModuleVersionList(){ return pDisableModuleVersionList; }
	inline const deglGPDisableModuleVersionList &GetDisableModuleVersionList() const{ return pDisableModuleVersionList; }
	
	/** \brief Lodule list. */
	inline deglGPModuleList &GetModuleList(){ return pModuleList; }
	inline const deglGPModuleList &GetModuleList() const{ return pModuleList; }
	...
	void CopyFrom( const deglGameProfile &profile );
	
	/** \brief Verify profile. */
	void Verify( deglLauncher &launcher );
	
	/** \brief Verify module. */
	bool VerifyModule( deglLauncher &launcher, const char *moduleName, const char *moduleVersion, int requiredType ) const;
	 ...
	 */
	void Activate( deglLauncher &launcher, deglEngineInstance &engineInstance ) const;
	/*@}*/
};
