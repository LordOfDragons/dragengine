...
#ifndef _DEGLENGINEMODULELIST_H_
#define _DEGLENGINEMODULELIST_H_
...
public:
	...
	deglEngineModule *GetModuleAt( int index ) const;
	/** \brief Retrieve the highest version module with the given name or NULL if not found. */
	deglEngineModule *GetModuleNamed( const char *name ) const;
	/** \brief Retrieve the module with the given name and version or NULL if not found. */
	deglEngineModule *GetModuleNamed( const char *name, const char *version ) const;
	/** \brief Module with the given name and at least version or NULL if not found. */
	deglEngineModule *GetModuleNamedAtLeast( const char *name, const char *version ) const;
	...
	bool HasModule( deglEngineModule *module ) const;
	...
	int IndexOfModule( deglEngineModule *module ) const;
	...
	/** \brief Adds a module. */
	void AddModule( deglEngineModule *module );
	/** \brief Removes a module. */
	void RemoveModule( deglEngineModule *module );
