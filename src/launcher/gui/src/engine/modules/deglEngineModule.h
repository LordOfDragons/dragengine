...
#ifndef _DEGLENGINEMODULE_H_
#define _DEGLENGINEMODULE_H_

#include "parameter/deglEMParameterList.h"
 ...
 */
class deglEngineModule : public deObject{
public:
	/** Module Status. */
	enum eModuleStatus{
		/** Everything is okay. */
...
private:
	...
	deglEMParameterList pParameterList;
...
public:
	...
	inline deglEMParameterList &GetParameterList(){ return pParameterList; }
	inline const deglEMParameterList &GetParameterList() const{ return pParameterList; }
	
	/** \brief Calculate file size and hashes. */
	void CalcSizeAndHashes( deglLauncher &launcher );
	/*@}*/
};
