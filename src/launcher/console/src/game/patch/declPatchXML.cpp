...
declPatchXML::declPatchXML( deLogger *logger, const char *loggerSource ) :
declBaseXML( logger, loggerSource ){
}

declPatchXML::~declPatchXML(){
}
...
void declPatchXML::ReadFromFile( decBaseFileReader &reader, declPatch &patch ){
...
void declPatchXML::pReadPatch( const decXmlElementTag &root, declPatch &patch ){
