...
void declGame::LoadConfig(){
	...
	const declGameProfile * const defaultProfile = pLauncher.GetGameManager()->GetDefaultProfile();
	if( defaultProfile ){
		declGameProfile * const profile = ( declGameProfile* )( deObject * )pCustomProfile;
