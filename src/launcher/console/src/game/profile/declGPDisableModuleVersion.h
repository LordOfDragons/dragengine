...
#ifndef _DECLGPDISABLEMODULEVERSION_H_
#define _DECLGPDISABLEMODULEVERSION_H_
 ...
 */
class declGPDisableModuleVersion : public deObject{
private:
	decString pName;
	decString pVersion;
...
public:
	...
	declGPDisableModuleVersion();
	declGPDisableModuleVersion( const char *name, const char *version );
	/** \brief Create a copy of a game profile disable module version. */
	declGPDisableModuleVersion( const declGPDisableModuleVersion &copy );
	/** \brief Clean up the game profile disable module version. */
	virtual ~declGPDisableModuleVersion();
	/*@}*/
	 ...
	 */
	bool operator==( const declGPDisableModuleVersion &other ) const;
	/**
	...
	declGPDisableModuleVersion &operator=( const declGPDisableModuleVersion &other );
	/*@}*/
};
