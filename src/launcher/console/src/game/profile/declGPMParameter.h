...
#ifndef _DECLGPMPARAMETER_H_
#define _DECLGPMPARAMETER_H_
 ...
 */
class declGPMParameter : public deObject{
private:
	decString pName;
	decString pValue;
...
public:
	...
	declGPMParameter( const char *name = "", const char *value = "" );
	/** Cleans up the game profile. */
	virtual ~declGPMParameter();
	/*@}*/
