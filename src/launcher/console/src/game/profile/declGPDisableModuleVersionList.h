...
#ifndef _DECLGPDISABLEMODULEVERSIONLIST_H_
#define _DECLGPDISABLEMODULEVERSIONLIST_H_
...
public:
	...
	declGPDisableModuleVersionList();
	/** \brief Create a copy of a game profile disable module version list. */
	declGPDisableModuleVersionList( const declGPDisableModuleVersionList &copy );
	...
	declGPDisableModuleVersion *GetAt( int index ) const;
	/** \brief Retrieve the matching entry or NULL if not found. */
	declGPDisableModuleVersion *GetWith( const char *name, const char *version ) const;
	/** \brief Determine if an entry exists. */
	bool Has( declGPDisableModuleVersion *entry ) const;
	...
	int IndexOf( declGPDisableModuleVersion *entry ) const;
	/** \brief Retrieve index of a matching entry or -1 if not found. */
	int IndexOfWith( const char *name, const char *version ) const;
	/** \brief Add an entry. */
	void Add( declGPDisableModuleVersion *entry );
	/** \brief Remove an entry. */
	void Remove( declGPDisableModuleVersion *entry );
	...
	declGPDisableModuleVersionList &operator=( const declGPDisableModuleVersionList &other );
	/*@}*/
};
