...
void declRunGame::PrintSyntax(){
	...
	printf( "\n" );
	printf( "Syntax:\n" );
	printf( "delauncherconsole run [ <options> ] { <game> | -f <game.xml> | --file <game.xml>> } [ <game-options> ]\n" );
	printf( "   <options> can be one or more of the following:\n" );
	printf( "      -c, --console         Use console and no graphic system.\n" );
	printf( "      -p, --profile         Use named game profile instead of the default one.\n" );
	printf( "      -d, --debug           Display all debug informations in the console not just the log file.\n" );
	printf( "      -P, --patch           Use patch with identifier instead of latest. Use empty string to run unpatched.\n" );
	printf( "      --mparam module:param=value     Set module parameter before running the game.\n" );
	printf( "   <game>                Identifier of the game to run.\n" );
	printf( "   -f <game.xml>         Game definition file to run.\n" );
	printf( "   --file <game.xml>     Game definition file to run.\n" );
	printf( "   \n" );
