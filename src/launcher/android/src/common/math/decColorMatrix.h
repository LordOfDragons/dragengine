...
public:
	 ...
	 * \details The parameters fill the colons from 1 to 5 in the appropriate order..
	 */
	 ...
	 * \details Brightness can be positive or negative.
	 */
	 ...
	 * \details Contrast can be positive or negative.
	 */
	 ...
	 * \details Saturation can be positive or negative.
	 */
	 ...
	 * \details Mathematically this only works on a 5x5 matrix. The color matrix
	 ...
	 * \details Mathematically this only works for a 5x5 matrix. The color matrix
	 ...
	 * \details \em color alpha is assumed to be one. Result alpha is set to 1.
	 */
	 ...
	 * \details Mathematically this results in a 5x5 matrix. The last row is discarded.
	 */
	decColorMatrix &operator*=( const decColorMatrix &matrix );
