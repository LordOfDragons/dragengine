...
// rp = ray position
// rd = ray direction
float decCollisionDetection::RayPlane(const decVector &pp, const decVector &pn,
...
decVector decCollisionDetection::ClosestPointOnLine( const decVector &lineFrom, const decVector &lineTo, const decVector &point ){
...
decVector decCollisionDetection::ClosestPointOnRay( const decVector &rayOrigin, const decVector &rayDirection, const decVector &point ){
...
// p = point to check
decVector decCollisionDetection::ClosestPointOnTriangleEdge(const decVector &tp1,
...
decVector decCollisionDetection::ClosestPointOnTriangle( const decVector &tp1,
const decVector &tp2, const decVector &tp3, const decVector &p ){
...
// p = point to check
decVector decCollisionDetection::ClosestPointOnQuadEdge(const decVector &tp1,
...
decVector decCollisionDetection::ClosestPointOnQuad( const decVector &tp1,
const decVector &tp2, const decVector &tp3, const decVector &tp4, const decVector &p ){
	const decVector edge0 = tp2 - tp1;
	const decVector edge1 = tp3 - tp2;
	const decVector faceNormal = ( edge0 % edge1 ).Normalized();
...
// sc = sphere center
// sr = sphere radius
float decCollisionDetection::RaySphere(const decVector &rp, const decVector &rd,
...
float decCollisionDetection::SegmentSegmentDistance( const decVector &as, const decVector &ae,
...
float decCollisionDetection::PointRayDistance( const decVector &rayOrigin, const decVector &rayDirection, const decVector &point ){
...
bool decCollisionDetection::PointInTriangle(const decVector &tp1, const decVector &tp2,
...
bool decCollisionDetection::PointInQuad(const decVector &tp1, const decVector &tp2,
...
bool decCollisionDetection::RayHitsSphere( const decVector &rayOrigin, const decVector &rayDirection,
...
bool decCollisionDetection::SphereHitsSphere( const decVector &sphere1Center, float sphere1Radius,
...
float decCollisionDetection::SphereMoveHitsSphere( const decVector &sphere1Center, float sphere1Radius,
...
bool decCollisionDetection::RayHitsBox( const decVector &rayOrigin, const decVector &rayDirection,
...
int decCollisionDetection::AABoxIntersectsAABox( const decVector &minExtend1, const decVector &maxExtend1, const decVector &minExtend2, const decVector &maxExtend2 ){
...
bool decCollisionDetection::RayHitsCylinder( const decVector &rayOrigin, const decVector &rayDirection,
...
bool decCollisionDetection::RayHitsTaperedCylinder( const decVector &rayOrigin, const decVector &rayDirection,
...
bool decCollisionDetection::RayHitsCapsule( const decVector &rayOrigin, const decVector &rayDirection,
...
bool decCollisionDetection::RayHitsTaperedCapsule( const decVector &rayOrigin, const decVector &rayDirection,
...
bool decCollisionDetection::RayHitsTriangle( const decVector &rayOrigin, const decVector &rayDirection,
