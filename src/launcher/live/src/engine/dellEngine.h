...
#ifndef _DELLENGINE_H_
#define _DELLENGINE_H_
...
#include "modules/dellEngineModuleList.h"
...
private:
	...
	decString pPathLib;
	dellEngineModuleList pModuleList;
...
public:
	...
	dellEngine( dellLauncher &launcher );
	...
	inline dellEngineModuleList &GetModuleList(){ return pModuleList; }
	inline const dellEngineModuleList &GetModuleList() const{ return pModuleList; }
	...
	dellEngineModule *GetBestModuleForType( int moduleType );
