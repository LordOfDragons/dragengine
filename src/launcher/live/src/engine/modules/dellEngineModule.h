...
#ifndef _DELLENGINEMODULE_H_
#define _DELLENGINEMODULE_H_

#include "parameter/dellEMParameterList.h"
 ...
 */
class dellEngineModule : public deObject{
public:
	/** Module Status. */
	enum eModuleStatus{
		/** Everything is okay. */
...
private:
	...
	dellEMParameterList pParameterList;
...
public:
	...
	inline dellEMParameterList &GetParameterList(){ return pParameterList; }
	inline const dellEMParameterList &GetParameterList() const{ return pParameterList; }
