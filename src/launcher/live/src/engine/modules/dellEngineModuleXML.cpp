...
// Class dellEngineModuleXML
//////////////////////////////

// Constructors and Destructors
/////////////////////////////////

dellEngineModuleXML::dellEngineModuleXML( deLogger *logger, const char *loggerSource ) : dellBaseXML( logger, loggerSource ){
}

dellEngineModuleXML::~dellEngineModuleXML(){
}
...
void dellEngineModuleXML::ReadFromFile( decBaseFileReader &reader, dellEngineModule &module ){
...
void dellEngineModuleXML::pReadModule( const decXmlElementTag &root, dellEngineModule &module ){
...
void dellEngineModuleXML::pReadModuleLibrary( const decXmlElementTag &root, dellEngineModule &module ){
	const int elementCount = root.GetElementCount();
	const decXmlElementTag *tag;
	int e;
