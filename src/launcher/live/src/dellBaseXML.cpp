...
dellBaseXML::dellBaseXML( deLogger *logger, const char *loggerSource ){
...
bool dellBaseXML::pHasAttribute( const decXmlElementTag &tag, const char *name ) const{
	return tag.FindAttribute( name ) != NULL;
}

const char *dellBaseXML::pGetAttributeString( const decXmlElementTag &tag, const char *name ) const{
...
int dellBaseXML::pGetAttributeInt( const decXmlElementTag &tag, const char *name ) const{
	const decXmlAttValue *value = tag.FindAttribute( name );
...
float dellBaseXML::pGetAttributeFloat( const decXmlElementTag &tag, const char *name ) const{
	const decXmlAttValue *value = tag.FindAttribute( name );
...
bool dellBaseXML::pGetAttributeBool( const decXmlElementTag &tag, const char *name ) const{
...
int dellBaseXML::pGetCDataInt( const decXmlElementTag &tag ) const{
...
float dellBaseXML::pGetCDataFloat( const decXmlElementTag &tag ) const{
	decXmlCharacterData *cdata = tag.GetFirstData();
...
const char *dellBaseXML::pGetCDataString( const decXmlElementTag &tag ) const{
	decXmlCharacterData *cdata = tag.GetFirstData();
...
bool dellBaseXML::pGetCDataBool( const decXmlElementTag &tag ) const{
...
void dellBaseXML::pErrorUnknownTag( const decXmlElementTag &root, const decXmlElementTag &tag ){
...
void dellBaseXML::pErrorUnknownValue( const decXmlElementTag &tag, const char *value ){
...
void dellBaseXML::pErrorMissingTag( const decXmlElementTag &root, const char *tagName ){
