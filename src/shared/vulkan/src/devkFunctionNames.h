...
DEVICE_LEVEL_VULKAN_FUNCTION(vkCmdSetStencilCompareMask)
DEVICE_LEVEL_VULKAN_FUNCTION(vkCmdSetStencilWriteMask)
DEVICE_LEVEL_VULKAN_FUNCTION(vkCmdSetStencilReference)
