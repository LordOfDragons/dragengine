...
public:
	...
	fbxRig( fbxScene &scene, fbxNode &nodePose, fbxNode *nodeDeformer );
...
public:
	...
	inline const decMatrix &GetWorldMatrixInverse() const{ return pWorldMatrix; }
