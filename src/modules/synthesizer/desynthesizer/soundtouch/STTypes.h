...
namespace soundtouch
{
    ...
    /*
    // RPTD: this check is not valid anymore for NDK r12 upwards. In r12 upwards
    //       the hard-float calling convention has been dropped. The soft-fp
    //       calling convention is not speed wise different anymore than hard-fp
...
// RPTD Fix:
// Using MinGW using runtime_error results in missing symbols causing the module to
