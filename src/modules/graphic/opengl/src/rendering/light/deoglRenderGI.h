...
private:
	deoglPipeline::Ref pPipelineResizeMaterials;
	deoglPipeline::Ref pPipelineTraceRays;
	deoglPipeline::Ref pPipelineTraceRaysCache;
	deoglPipeline::Ref pPipelineCopyRayCache;
	deoglPipeline::Ref pPipelineInitFromRayCache;
	deoglPipeline::Ref pPipelineCopyProbeIrradiance;
	deoglPipeline::Ref pPipelineUpdateProbeIrradiance;
	deoglPipeline::Ref pPipelineUpdateProbeDistance;
	deoglPipeline::Ref pPipelineClearProbeIrradiance;
	deoglPipeline::Ref pPipelineClearProbeDistance;
	deoglPipeline::Ref pPipelineMoveProbes;
	deoglPipeline::Ref pPipelineDynamicState;
	deoglPipeline::Ref pPipelineProbeOffset;
	deoglPipeline::Ref pPipelineProbeExtends;
	deoglPipeline::Ref pPipelineLight;
	deoglPipeline::Ref pPipelineLightStereo;
	deoglPipeline::Ref pPipelineLightTransp;
	deoglPipeline::Ref pPipelineLightTranspStereo;
	deoglPipeline::Ref pPipelineLightGIRay;
	deoglPipeline::Ref pPipelineDebugProbe;
	deoglPipeline::Ref pPipelineDebugProbeXRay;
	deoglPipeline::Ref pPipelineDebugProbeOffset;
	deoglPipeline::Ref pPipelineDebugProbeOffsetXRay;
	deoglPipeline::Ref pPipelineDebugProbeUpdatePass1;
	deoglPipeline::Ref pPipelineDebugProbeUpdatePass2;
