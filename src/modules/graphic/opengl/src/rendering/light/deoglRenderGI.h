...
private:
	deoglPipeline *pPipelineResizeMaterials;
	deoglPipeline *pPipelineTraceRays;
	deoglPipeline *pPipelineTraceRaysCache;
	deoglPipeline *pPipelineCopyRayCache;
	deoglPipeline *pPipelineInitFromRayCache;
	deoglPipeline *pPipelineCopyProbeIrradiance;
	deoglPipeline *pPipelineUpdateProbeIrradiance;
	deoglPipeline *pPipelineUpdateProbeDistance;
	deoglPipeline *pPipelineClearProbeIrradiance;
	deoglPipeline *pPipelineClearProbeDistance;
	deoglPipeline *pPipelineMoveProbes;
	deoglPipeline *pPipelineDynamicState;
	deoglPipeline *pPipelineProbeOffset;
	deoglPipeline *pPipelineProbeExtends;
	deoglPipeline *pPipelineLight;
	deoglPipeline *pPipelineLightStereo;
	deoglPipeline *pPipelineLightTransp;
	deoglPipeline *pPipelineLightTranspStereo;
	deoglPipeline *pPipelineLightGIRay;
	deoglPipeline *pPipelineDebugProbe;
	deoglPipeline *pPipelineDebugProbeXRay;
	deoglPipeline *pPipelineDebugProbeOffset;
	deoglPipeline *pPipelineDebugProbeOffsetXRay;
	deoglPipeline *pPipelineDebugProbeUpdatePass1;
	deoglPipeline *pPipelineDebugProbeUpdatePass2;
