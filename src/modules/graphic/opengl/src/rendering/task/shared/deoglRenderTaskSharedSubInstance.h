...
#ifndef _DEOGLRENDERTASKSHAREDSUBINSTANCE_H_
#define _DEOGLRENDERTASKSHAREDSUBINSTANCE_H_
...
public:
	...
	deoglRenderTaskSharedSubInstance( deoglRenderTaskSharedPool &pool, int index );
	
	/** Clean up shared render task shader. */
	~deoglRenderTaskSharedSubInstance();
	/*@}*/
