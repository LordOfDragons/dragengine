...
#ifndef _DEOGLLIGHTVOLUMEBUILDER_H_
#define _DEOGLLIGHTVOLUMEBUILDER_H_
...
public:
	...
	/** Cleans up the light volume builder. */
	~deoglLightVolumeBuilder();
	/*@}*/
	...
	/**
	 * Crops a volume list using a triangles list. The triangles are extruded radially simulating light
	 * blocked by obstacles. The distance indicates how far triangles are extruded and should be at least
	...
	/**
	 * Crops the volume list using an occlusion mesh. The faces are extruded radially simulating light
