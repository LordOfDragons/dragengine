...
#ifndef _DEOGLMEMORYCONSUMPTIONSKINUSE_H_
#define _DEOGLMEMORYCONSUMPTIONSKINUSE_H_
...
/**
 * Skin memory consumption usage.
 */
class deoglMemoryConsumptionSkinUse{
public:
	deoglMemoryConsumptionGPUUse compressed;
	deoglMemoryConsumptionGPUUse uncompressed;
