...
#ifndef _DEOGLDEFAULTOCTREE_H_
#define _DEOGLDEFAULTOCTREE_H_
 ...
 */
class deoglDefaultOctree : public deoglOctree{
private:
	void **pElements;
	int pElementCount;
	int pElementSize;
...
public:
	...
	deoglDefaultOctree( const decVector &center, const decVector &halfSize );
	/** Cleans up the generic octree object. */
	virtual ~deoglDefaultOctree();
	/*@}*/
	 ...
	 */
	deoglDefaultOctree *InsertIntoTree( void *element, const decVector &boxCenter, const decVector &boxHalfSize, int maxDepth = deoglDO_MAX_DEPTH );
	/*@}*/
