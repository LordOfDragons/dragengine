...
deoglCollisionTriangle::deoglCollisionTriangle(){
}

deoglCollisionTriangle::deoglCollisionTriangle( const decVector &corner1, const decVector &corner2, const decVector &corner3 ){
	SetCorners( corner1, corner2, corner3 );
}

deoglCollisionTriangle::deoglCollisionTriangle( const decVector &corner1, const decVector &corner2, const decVector &corner3, const decVector &normal ){
...
bool deoglCollisionTriangle::VolumeHitsVolume( deoglCollisionVolume *volume ){
	return volume->TriangleHitsVolume( this );
}

float deoglCollisionTriangle::VolumeMoveHitsVolume( deoglCollisionVolume *volume, const decVector &displacement, decVector *normal ){
...
bool deoglCollisionTriangle::SphereHitsVolume( deoglCollisionSphere *sphere ){
	return SphereHitsTriangle( sphere );
}

bool deoglCollisionTriangle::CylinderHitsVolume( deoglCollisionCylinder *cylinder ){
	return CylinderHitsTriangle( cylinder );
}

bool deoglCollisionTriangle::CapsuleHitsVolume( deoglCollisionCapsule *capsule ){
	return CapsuleHitsTriangle( capsule );
}

bool deoglCollisionTriangle::BoxHitsVolume( deoglCollisionBox *box ){
	return BoxHitsTriangle( box );
}

bool deoglCollisionTriangle::TriangleHitsVolume( deoglCollisionTriangle *triangle ){
	return TriangleHitsTriangle( triangle );
}

bool deoglCollisionTriangle::FrustumHitsVolume( deoglCollisionFrustum *frustum ){
	return frustum->TriangleHitsFrustum( this );
}



float deoglCollisionTriangle::SphereMoveHitsVolume( deoglCollisionSphere *sphere, const decVector &displacement, decVector *normal ){
	return SphereMoveHitsTriangle( sphere, displacement, normal );
}

float deoglCollisionTriangle::CylinderMoveHitsVolume( deoglCollisionCylinder *cylinder, const decVector &displacement, decVector *normal ){
	return CylinderMoveHitsTriangle( cylinder, displacement, normal );
}

float deoglCollisionTriangle::CapsuleMoveHitsVolume( deoglCollisionCapsule *capsule, const decVector &displacement, decVector *normal ){
	return CapsuleMoveHitsTriangle( capsule, displacement, normal );
}

float deoglCollisionTriangle::BoxMoveHitsVolume( deoglCollisionBox *box, const decVector &displacement, decVector *normal ){
	return BoxMoveHitsTriangle( box, displacement, normal );
}

float deoglCollisionTriangle::TriangleMoveHitsVolume( deoglCollisionTriangle *triangle, const decVector &displacement, decVector *normal ){
	return TriangleMoveHitsTriangle( triangle, displacement, normal );
}

float deoglCollisionTriangle::FrustumMoveHitsVolume( deoglCollisionFrustum *frustum, const decVector &displacement, decVector *normal ){
	float distance = frustum->TriangleMoveHitsFrustum( this, -displacement, normal );
	if( normal ) normal->Negate();
	return distance;
}

float deoglCollisionTriangle::PointMoveHitsVolume( const decVector &point, const decVector &displacement, decVector *normal ){
	decVector hitPoint;
	...
	if( dot < -0.00001 || dot > 0.00001f ){
		...
		if( lambda < 0.0f || lambda > 1.0f ){
			...
			if( deoglCollisionDetection::PointInTriangle( pCorners[ 0 ], pCorners[ 1 ],
			pCorners[ 2 ], hitPoint ) ){
				if( normal ){
...
void deoglCollisionTriangle::GetEnclosingSphere( deoglCollisionSphere *sphere ){
...
bool deoglCollisionTriangle::IsPointInside( const decVector &point ){
	return false; // triangles are infinitesimally thin
}

decVector deoglCollisionTriangle::ClosestPointTo( const decVector &point ){
	decVector hitPoint = point - pNormal * ( point * pNormal - pDist );
	if( deoglCollisionDetection::PointInTriangle( pCorners[ 0 ], pCorners[ 1 ], pCorners[ 2 ], hitPoint ) ){
		return hitPoint;
	}else{
		return deoglCollisionDetection::ClosestPointOnTriangleEdge( pCorners[ 0 ], pCorners[ 1 ], pCorners[ 2 ], hitPoint );
	}
}
...
void deoglCollisionTriangle::Visit( deoglCollisionVolumeVisitor *visitor ){
...
bool deoglCollisionTriangle::SphereHitsTriangle( deoglCollisionSphere *sphere ){
	...
	if( ! deoglCollisionDetection::PointInTriangle( pCorners[ 0 ], pCorners[ 1 ], pCorners[ 2 ], hitPoint ) ){
		hitPoint = deoglCollisionDetection::ClosestPointOnTriangleEdge( pCorners[ 0 ], pCorners[ 1 ], pCorners[ 2 ], hitPoint );
	}
...
bool deoglCollisionTriangle::CylinderHitsTriangle( deoglCollisionCylinder *cylinder ){
	return false;
}

bool deoglCollisionTriangle::CapsuleHitsTriangle( deoglCollisionCapsule *capsule ){
	return false;
}

bool deoglCollisionTriangle::BoxHitsTriangle( deoglCollisionBox *box ){
...
bool deoglCollisionTriangle::TriangleHitsTriangle( deoglCollisionTriangle *triangle ){
	return false;
}



float deoglCollisionTriangle::SphereMoveHitsTriangle( deoglCollisionSphere *sphere, const decVector &displacement, decVector *normal ){
	const decVector &sc = sphere->GetCenter();
...
float deoglCollisionTriangle::CylinderMoveHitsTriangle( deoglCollisionCylinder *cylinder, const decVector &displacement, decVector *normal ){
	return 1.0f;
}

float deoglCollisionTriangle::CapsuleMoveHitsTriangle( deoglCollisionCapsule *capsule, const decVector &displacement, decVector *normal ){
	return 1.0f;
}
...
float deoglCollisionTriangle::BoxMoveHitsTriangle( deoglCollisionBox *box, const decVector &displacement, decVector *normal ){
	const decVector &bhs = box->GetHalfSize();
	const decVector &bc = box->GetCenter();
	...
	if( normal ){
		...
		if( hitAtStart ){
			...
			if( deoglCollisionDetection::PointInTriangle( pCorners[ 0 ], pCorners[ 1 ], pCorners[ 2 ], projPoint ) ){
				normal->Set( pNormal );
			}else{
...
float deoglCollisionTriangle::TriangleMoveHitsTriangle( deoglCollisionTriangle *triangle, const decVector &displacement, decVector *normal ){
	return 1;
}
...
void deoglCollisionTriangle::SetCorners( const decVector &corner1, const decVector &corner2, const decVector &corner3 ){
	SetCorners( corner1, corner2, corner3, ( ( corner2 - corner1 ) % ( corner3 - corner2 ) ).Normalized() );
}

void deoglCollisionTriangle::SetCorners( const decVector &corner1, const decVector &corner2, const decVector &corner3, const decVector &normal ){
	pCorners[ 0 ] = corner1;
	pCorners[ 1 ] = corner2;
	pCorners[ 2 ] = corner3;
