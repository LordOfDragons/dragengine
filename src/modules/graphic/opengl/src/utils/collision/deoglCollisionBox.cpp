...
deoglCollisionBox::deoglCollisionBox(){
	pHalfSize.Set( 1.0f, 1.0f, 1.0f );
	ClearOrientation();
}

deoglCollisionBox::deoglCollisionBox( const decVector &center, const decVector &halfSize ) :
pCenter( center ),
pHalfSize( halfSize )
{
	ClearOrientation();
...
bool deoglCollisionBox::VolumeHitsVolume( deoglCollisionVolume *volume ){
	return volume->BoxHitsVolume( this );
}

float deoglCollisionBox::VolumeMoveHitsVolume( deoglCollisionVolume *volume, const decVector &displacement, decVector *normal ){
...
bool deoglCollisionBox::SphereHitsVolume( deoglCollisionSphere *sphere ){
	return SphereHitsBox( sphere );
}

bool deoglCollisionBox::CylinderHitsVolume( deoglCollisionCylinder *cylinder ){
	return CylinderHitsBox( cylinder );
}

bool deoglCollisionBox::CapsuleHitsVolume( deoglCollisionCapsule *capsule ){
	return CapsuleHitsBox( capsule );
}

bool deoglCollisionBox::BoxHitsVolume( deoglCollisionBox *box ){
	return BoxHitsBox( box );
}

bool deoglCollisionBox::TriangleHitsVolume( deoglCollisionTriangle *triangle ){
	return triangle->BoxHitsTriangle( this );
}

bool deoglCollisionBox::FrustumHitsVolume( deoglCollisionFrustum *frustum ){
	return frustum->BoxHitsFrustum( this );
}



float deoglCollisionBox::SphereMoveHitsVolume( deoglCollisionSphere *sphere, const decVector &displacement, decVector *normal ){
	return SphereMoveHitsBox( sphere, displacement, normal );
}

float deoglCollisionBox::CylinderMoveHitsVolume( deoglCollisionCylinder *cylinder, const decVector &displacement, decVector *normal ){
	return CylinderMoveHitsBox( cylinder, displacement, normal );
}

float deoglCollisionBox::CapsuleMoveHitsVolume( deoglCollisionCapsule *capsule, const decVector &displacement, decVector *normal ){
	return CapsuleMoveHitsBox( capsule, displacement, normal );
}

float deoglCollisionBox::BoxMoveHitsVolume( deoglCollisionBox *box, const decVector &displacement, decVector *normal ){
	return BoxMoveHitsBox( box, displacement, normal );
}

float deoglCollisionBox::TriangleMoveHitsVolume( deoglCollisionTriangle *triangle, const decVector &displacement, decVector *normal ){
	float distance = triangle->BoxMoveHitsTriangle( this, -displacement, normal );
	if( normal ) normal->Negate();
	return distance;
}

float deoglCollisionBox::FrustumMoveHitsVolume( deoglCollisionFrustum *frustum, const decVector &displacement, decVector *normal ){
	float distance = frustum->BoxMoveHitsFrustum( this, -displacement, normal );
	if( normal ) normal->Negate();
	return distance;
}

float deoglCollisionBox::PointMoveHitsVolume( const decVector &point, const decVector &displacement, decVector *normal ){
...
bool deoglCollisionBox::SphereHitsBox( deoglCollisionSphere *sphere ){
...
bool deoglCollisionBox::CylinderHitsBox( deoglCollisionCylinder *cylinder ){
	return false;
}

bool deoglCollisionBox::CapsuleHitsBox( deoglCollisionCapsule *capsule ){
	/*
	...
	// front 4 edges
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 0 ], corners[ 1 ] ) <= radius ) return true;
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 1 ], corners[ 2 ] ) <= radius ) return true;
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 2 ], corners[ 3 ] ) <= radius ) return true;
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 3 ], corners[ 0 ] ) <= radius ) return true;
	// back 4 edges
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 4 ], corners[ 5 ] ) <= radius ) return true;
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 5 ], corners[ 6 ] ) <= radius ) return true;
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 6 ], corners[ 7 ] ) <= radius ) return true;
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 7 ], corners[ 4 ] ) <= radius ) return true;
	// connection 4 edges
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 0 ], corners[ 4 ] ) <= radius ) return true;
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 1 ], corners[ 5 ] ) <= radius ) return true;
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 2 ], corners[ 6 ] ) <= radius ) return true;
	if( deoglCollisionDetection::SegmentSegmentDistance( cs, ce, corners[ 3 ], corners[ 7 ] ) <= radius ) return true;
	// it has to miss
	*/
	return false;
}

bool deoglCollisionBox::BoxHitsBox( deoglCollisionBox *box ){
...
float deoglCollisionBox::SphereMoveHitsBox( deoglCollisionSphere *sphere, const decVector &displacement, decVector *normal ){
...
float deoglCollisionBox::CylinderMoveHitsBox( deoglCollisionCylinder *cylinder, const decVector &displacement, decVector *normal ){
	return 1;
}

float deoglCollisionBox::CapsuleMoveHitsBox( deoglCollisionCapsule *capsule, const decVector &displacement, decVector *normal ){
	return 1;
}

float deoglCollisionBox::BoxMoveHitsBox( deoglCollisionBox *box, const decVector &displacement, decVector *normal ){
...
void deoglCollisionBox::GetEnclosingSphere( deoglCollisionSphere *sphere ){
	if( ! sphere ) DETHROW( deeInvalidParam );
	sphere->SetAll( pCenter, pHalfSize.Length() );
}

void deoglCollisionBox::GetEnclosingBox( deoglCollisionBox *box ){
	if( ! box ){
...
bool deoglCollisionBox::IsPointInside( const decVector &point ){
	const decVector localPoint = WorldToLocal( point );
	
	return localPoint >= -pHalfSize && localPoint <= pHalfSize;
}

decVector deoglCollisionBox::ClosestPointTo( const decVector &point ){
	if( pOriented ){
...
decVector deoglCollisionBox::NormalAtPoint( const decVector &point ){
...
bool deoglCollisionBox::RayHitsVolume( const decVector &rayOrigin, const decVector &rayDirection, float &hitDistance ){
	if( pOriented ){
		return deoglCollisionDetection::RayHitsBox( WorldToLocal( rayOrigin ), NormalWorldToLocal( rayDirection ),
			decVector(), pHalfSize, hitDistance );
		
	}else{
		return deoglCollisionDetection::RayHitsBox( rayOrigin, rayDirection, pCenter, pHalfSize, hitDistance );
	}
}
...
void deoglCollisionBox::Visit( deoglCollisionVolumeVisitor *visitor ){
...
void deoglCollisionBox::SetCenter( const decVector &center ){
	pCenter = center;
}
...
void deoglCollisionBox::ClearOrientation(){
...
void deoglCollisionBox::SetFromExtends( const decVector &minExtend, const decVector &maxExtend ){
	pHalfSize = ( maxExtend - minExtend ) * 0.5f;
	pCenter = minExtend + pHalfSize;
	ClearOrientation();
}

void deoglCollisionBox::MoveBy( const decVector &offset ){
	pCenter += offset;
}
...
decVector deoglCollisionBox::WorldToLocal( const decVector &point ) const{
	const decVector tp = point - pCenter;
	return decVector( pAxisX * tp, pAxisY * tp, pAxisZ * tp );
}

decVector deoglCollisionBox::LocalToWorld( const decVector &point ) const{
	return pCenter + pAxisX * point.x + pAxisY * point.y + pAxisZ * point.z;
}

decVector deoglCollisionBox::NormalWorldToLocal( const decVector &normal ) const{
	return decVector( pAxisX * normal, pAxisY * normal, pAxisZ * normal );
}

decVector deoglCollisionBox::NormalLocalToWorld( const decVector &normal ) const{
	return pAxisX * normal.x + pAxisY * normal.y + pAxisZ * normal.z;
}

decVector deoglCollisionBox::pAxisAlignedCPTo( const decVector &point ){
