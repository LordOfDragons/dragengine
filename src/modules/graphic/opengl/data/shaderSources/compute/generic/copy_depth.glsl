...
layout(rgba32f, binding=1) uniform restrict writeonly restrict image2DArray outDepth;

#ifdef WITH_COLOR
layout(rgba32f, binding=2) uniform restrict readonly image2DArray inColor;
layout(rgba32f, binding=3) uniform restrict writeonly restrict image2DArray outColor;
#endif
