...
const uint erfDecalSolidParent = uint(0x200);
const uint erfDoubleSided = uint(0x400);
const uint erfXRay = uint(0x800);
const uint erfOcclusion = uint(0x1000);
const uint erfShadow = uint(0x2000);
const uint erfCompactShadow = uint(0x4000);
