...
float depthToZ( ARG_SAMP_HIGHP sampler2DArray samplerDepth, in int layer ){
...
vec3 depthToPosition( ARG_SAMP_HIGHP sampler2DArray samplerDepth, in vec2 screenCoord, in int layer ){
