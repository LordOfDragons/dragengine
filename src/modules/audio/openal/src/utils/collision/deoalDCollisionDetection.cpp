...
// rp = ray position
// rd = ray direction
double deoalDCollisionDetection::RayPlane(const decDVector &pp, const decDVector &pn,
...
decDVector deoalDCollisionDetection::ClosestPointOnLine( const decDVector &lineFrom, const decDVector &lineTo, const decDVector &point ){
...
decDVector deoalDCollisionDetection::ClosestPointOnRay( const decDVector &rayOrigin, const decDVector &rayDirection, const decDVector &point ){
...
// p = point to check
decDVector deoalDCollisionDetection::ClosestPointOnTriangleEdge(const decDVector &tp1,
...
decDVector deoalDCollisionDetection::ClosestPointOnTriangle( const decDVector &tp1,
const decDVector &tp2, const decDVector &tp3, const decDVector &p ){
...
// p = point to check
decDVector deoalDCollisionDetection::ClosestPointOnQuadEdge(const decDVector &tp1,
...
decDVector deoalDCollisionDetection::ClosestPointOnQuad( const decDVector &tp1,
const decDVector &tp2, const decDVector &tp3, const decDVector &tp4, const decDVector &p ){
	const decDVector edge0 = tp2 - tp1;
	const decDVector edge1 = tp3 - tp2;
	const decDVector faceNormal = ( edge0 % edge1 ).Normalized();
...
// sc = sphere center
// sr = sphere radius
double deoalDCollisionDetection::RaySphere(const decDVector &rp, const decDVector &rd,
...
double deoalDCollisionDetection::SegmentSegmentDistance( const decDVector &as, const decDVector &ae,
...
double deoalDCollisionDetection::PointRayDistance( const decDVector &rayOrigin, const decDVector &rayDirection, const decDVector &point ){
...
bool deoalDCollisionDetection::PointInTriangle(const decDVector &tp1, const decDVector &tp2,
...
bool deoalDCollisionDetection::PointInQuad(const decDVector &tp1, const decDVector &tp2,
...
bool deoalDCollisionDetection::RayHitsSphere( const decDVector &rayOrigin, const decDVector &rayDirection,
...
bool deoalDCollisionDetection::SphereHitsSphere( const decDVector &sphere1Center, double sphere1Radius,
...
double deoalDCollisionDetection::SphereMoveHitsSphere( const decDVector &sphere1Center, double sphere1Radius,
...
bool deoalDCollisionDetection::RayHitsBox( const decDVector &rayOrigin, const decDVector &rayDirection,
...
int deoalDCollisionDetection::AABoxIntersectsAABox( const decDVector &minExtend1, const decDVector &maxExtend1, const decDVector &minExtend2, const decDVector &maxExtend2 ){
...
bool deoalDCollisionDetection::RayHitsCylinder( const decDVector &rayOrigin, const decDVector &rayDirection,
...
bool deoalDCollisionDetection::RayHitsTaperedCylinder( const decDVector &rayOrigin, const decDVector &rayDirection,
...
bool deoalDCollisionDetection::RayHitsCapsule( const decDVector &rayOrigin, const decDVector &rayDirection,
...
bool deoalDCollisionDetection::RayHitsTaperedCapsule( const decDVector &rayOrigin, const decDVector &rayDirection,
...
bool deoalDCollisionDetection::RayHitsTriangle( const decDVector &rayOrigin, const decDVector &rayDirection,
