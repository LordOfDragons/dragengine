...
void deoxrDebugCheckCommand( XrResult result, deVROpenXR &oxr, const char *file, int line ){
	...
	CASE_ERROR( XR_TIMEOUT_EXPIRED )
	CASE_ERROR( XR_SESSION_LOSS_PENDING )
	CASE_ERROR( XR_EVENT_UNAVAILABLE )
	CASE_ERROR( XR_SPACE_BOUNDS_UNAVAILABLE )
	CASE_ERROR( XR_SESSION_NOT_FOCUSED )
	CASE_ERROR( XR_FRAME_DISCARDED )
