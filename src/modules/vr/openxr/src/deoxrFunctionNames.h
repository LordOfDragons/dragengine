...
INSTANCE_LEVEL_OPENXR_FUNCTION(xrDestroySpace)
...
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrCreateBodyTrackerFB, extFBBodyTracking)
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrDestroyBodyTrackerFB, extFBBodyTracking)
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrLocateBodyJointsFB, extFBBodyTracking)
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrGetBodySkeletonFB, extFBBodyTracking)
...
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrCreateXDevListMNDX, extMNDXXDevSpace)
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrGetXDevListGenerationNumberMNDX, extMNDXXDevSpace)
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrEnumerateXDevsMNDX, extMNDXXDevSpace)
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrGetXDevPropertiesMNDX, extMNDXXDevSpace)
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrDestroyXDevListMNDX, extMNDXXDevSpace)
INSTANCE_LEVEL_OPENXR_FUNCTION_FROM_EXTENSION(xrCreateXDevSpaceMNDX, extMNDXXDevSpace)
