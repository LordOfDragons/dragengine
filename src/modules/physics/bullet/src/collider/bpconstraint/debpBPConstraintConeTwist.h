...
#ifndef _DEBPBPCONSTRAINTCONETWIST_H_
#define _DEBPBPCONSTRAINTCONETWIST_H_
...
/**
 * @brief Bullet physics cone twist constraint adapter.
 */
class debpBPConstraintConeTwist : public btConeTwistConstraint, debpBPConstraintBase{
public:
