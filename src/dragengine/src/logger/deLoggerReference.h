...
#ifndef _DELOGGERREFERENCE_H_
#define _DELOGGERREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deLoggerReference : protected deObjectReference {
public:
	 ...
	 */
	deLoggerReference( deLogger *object );
	 ...
	 */
	deLoggerReference( const deLoggerReference &reference );
	/*@}*/
	 ...
	 */
	deLoggerReference &operator=( deLogger *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deLoggerReference &operator=( const deLoggerReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deLogger *object ) const;
	bool operator!=( deLogger *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deLoggerReference &reference ) const;
	bool operator!=( const deLoggerReference &reference ) const;
	/*@}*/
};
