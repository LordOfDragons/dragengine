...
void deBaseGraphicCamera::PositionChanged(){
}

void deBaseGraphicCamera::OrientationChanged(){
}

void deBaseGraphicCamera::ParameterChanged(){
}

void deBaseGraphicCamera::AdaptionChanged(){
}

void deBaseGraphicCamera::LayerMaskChanged(){
}
