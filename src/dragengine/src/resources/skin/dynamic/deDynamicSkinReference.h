...
#ifndef _DEDYNAMICSKINREFERENCE_H_
#define _DEDYNAMICSKINREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deDynamicSkinReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deDynamicSkinReference();
	 ...
	 */
	deDynamicSkinReference( deDynamicSkin *object );
	 ...
	 */
	deDynamicSkinReference( const deDynamicSkinReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deDynamicSkin *object );
	 ...
	 */
	deDynamicSkinReference &operator=( deDynamicSkin *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deDynamicSkinReference &operator=( const deDynamicSkinReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deDynamicSkin *object ) const;
	bool operator!=( deDynamicSkin *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deDynamicSkinReference &reference ) const;
	bool operator!=( const deDynamicSkinReference &reference ) const;
	/*@}*/
};
