...
#ifndef _DESOUNDREFERENCE_H_
#define _DESOUNDREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deSoundReference : protected deObjectReference {
public:
	 ...
	 */
	deSoundReference( deSound *object );
	 ...
	 */
	deSoundReference( const deSoundReference &reference );
	/*@}*/
	 ...
	 */
	deSoundReference &operator=( deSound *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deSoundReference &operator=( const deSoundReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deSound *object ) const;
	bool operator!=( deSound *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deSoundReference &reference ) const;
	bool operator!=( const deSoundReference &reference ) const;
	/*@}*/
};
