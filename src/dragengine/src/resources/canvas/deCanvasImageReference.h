...
#ifndef _DECANVASIMAGEREFERENCE_H_
#define _DECANVASIMAGEREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deCanvasImageReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deCanvasImageReference();
	 ...
	 */
	deCanvasImageReference( deCanvasImage *object );
	 ...
	 */
	deCanvasImageReference( const deCanvasImageReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deCanvasImage *object );
	 ...
	 */
	deCanvasImageReference &operator=( deCanvasImage *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deCanvasImageReference &operator=( const deCanvasImageReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deCanvasImage *object ) const;
	bool operator!=( deCanvasImage *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deCanvasImageReference &reference ) const;
	bool operator!=( const deCanvasImageReference &reference ) const;
	/*@}*/
};
