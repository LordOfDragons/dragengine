...
#ifndef _DECANVASPAINTREFERENCE_H_
#define _DECANVASPAINTREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deCanvasPaintReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deCanvasPaintReference();
	 ...
	 */
	deCanvasPaintReference( deCanvasPaint *object );
	 ...
	 */
	deCanvasPaintReference( const deCanvasPaintReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deCanvasPaint *object );
	 ...
	 */
	deCanvasPaintReference &operator=( deCanvasPaint *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deCanvasPaintReference &operator=( const deCanvasPaintReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deCanvasPaint *object ) const;
	bool operator!=( deCanvasPaint *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deCanvasPaintReference &reference ) const;
	bool operator!=( const deCanvasPaintReference &reference ) const;
	/*@}*/
};
