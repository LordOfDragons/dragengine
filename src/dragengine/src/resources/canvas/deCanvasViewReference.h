...
#ifndef _DECANVASVIEWREFERENCE_H_
#define _DECANVASVIEWREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deCanvasViewReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deCanvasViewReference();
	 ...
	 */
	deCanvasViewReference( deCanvasView *object );
	 ...
	 */
	deCanvasViewReference( const deCanvasViewReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deCanvasView *object );
	 ...
	 */
	deCanvasViewReference &operator=( deCanvasView *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deCanvasViewReference &operator=( const deCanvasViewReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deCanvasView *object ) const;
	bool operator!=( deCanvasView *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deCanvasViewReference &reference ) const;
	bool operator!=( const deCanvasViewReference &reference ) const;
	/*@}*/
};
