...
#ifndef _DEVIDEOAUDIODECODERREFERENCE_H_
#define _DEVIDEOAUDIODECODERREFERENCE_H_
...
/**
 * \brief Video audio decoder reference.
 * 
 ...
 */
class DE_DLL_EXPORT deVideoAudioDecoderReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deVideoAudioDecoderReference();
	 ...
	 */
	deVideoAudioDecoderReference( deVideoAudioDecoder *object );
	 ...
	 */
	deVideoAudioDecoderReference( const deVideoAudioDecoderReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deVideoAudioDecoder *object );
	...
	operator deVideoAudioDecoder*() const;
	 ...
	 * \throws deeNullPointer if object is NULL.
	 */
	deVideoAudioDecoder* operator->() const;
	 ...
	 */
	deVideoAudioDecoderReference &operator=( deVideoAudioDecoder *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deVideoAudioDecoderReference &operator=( const deVideoAudioDecoderReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deVideoAudioDecoder *object ) const;
	bool operator!=( deVideoAudioDecoder *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deVideoAudioDecoderReference &reference ) const;
	bool operator!=( const deVideoAudioDecoderReference &reference ) const;
	/*@}*/
};
