...
#ifndef _DEOCCLUSIONMESHREFERENCE_H_
#define _DEOCCLUSIONMESHREFERENCE_H_
...
/**
 * \brief Occlusion mesh reference.
 * 
 ...
 */
class DE_DLL_EXPORT deOcclusionMeshReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deOcclusionMeshReference();
	 ...
	 */
	deOcclusionMeshReference( deOcclusionMesh *object );
	 ...
	 */
	deOcclusionMeshReference( const deOcclusionMeshReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deOcclusionMesh *object );
	...
	operator deOcclusionMesh*() const;
	 ...
	 * \throws deeNullPointer if object is NULL.
	 */
	deOcclusionMesh* operator->() const;
	 ...
	 */
	deOcclusionMeshReference &operator=( deOcclusionMesh *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deOcclusionMeshReference &operator=( const deOcclusionMeshReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deOcclusionMesh *object ) const;
	bool operator!=( deOcclusionMesh *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deOcclusionMeshReference &reference ) const;
	bool operator!=( const deOcclusionMeshReference &reference ) const;
	/*@}*/
};
