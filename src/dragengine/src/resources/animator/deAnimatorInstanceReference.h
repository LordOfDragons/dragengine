...
#ifndef _DEANIMATORINSTANCEREFERENCE_H_
#define _DEANIMATORINSTANCEREFERENCE_H_
...
/**
 * \brief Animator instance reference.
 * 
...
public:
	 ...
	 */
	deAnimatorInstanceReference( deAnimatorInstance *object );
	 ...
	 */
	deAnimatorInstanceReference( const deAnimatorInstanceReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deAnimatorInstance *object );
	...
	operator deAnimatorInstance*() const;
	 ...
	 * \throws deeNullPointer if object is NULL.
	 */
	deAnimatorInstance* operator->() const;
	 ...
	 */
	deAnimatorInstanceReference &operator=( deAnimatorInstance *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deAnimatorInstanceReference &operator=( const deAnimatorInstanceReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deAnimatorInstance *object ) const;
	bool operator!=( deAnimatorInstance *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deAnimatorInstanceReference &reference ) const;
	bool operator!=( const deAnimatorInstanceReference &reference ) const;
	/*@}*/
};
