...
#ifndef _DERESOURCEREFERENCE_H_
#define _DERESOURCEREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deResourceReference : protected deObjectReference {
public:
	 ...
	 */
	deResourceReference( deResource *object );
	 ...
	 */
	deResourceReference( const deResourceReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deResource *object );
	 ...
	 */
	deResourceReference &operator=( deResource *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deResourceReference &operator=( const deResourceReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deResource *object ) const;
	bool operator!=( deResource *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deResourceReference &reference ) const;
	bool operator!=( const deResourceReference &reference ) const;
	/*@}*/
};
