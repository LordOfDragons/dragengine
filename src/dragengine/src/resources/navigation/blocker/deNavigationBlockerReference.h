...
#ifndef _DENAVIGATIONBLOCKERREFERENCE_H_
#define _DENAVIGATIONBLOCKERREFERENCE_H_
...
/**
 * \brief Navigation blocker reference.
 * 
 ...
 */
class DE_DLL_EXPORT deNavigationBlockerReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deNavigationBlockerReference();
	 ...
	 */
	deNavigationBlockerReference( deNavigationBlocker *object );
	 ...
	 */
	deNavigationBlockerReference( const deNavigationBlockerReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deNavigationBlocker *object );
	...
	operator deNavigationBlocker*() const;
	 ...
	 * \throws deeNullPointer if object is NULL.
	 */
	deNavigationBlocker* operator->() const;
	 ...
	 */
	deNavigationBlockerReference &operator=( deNavigationBlocker *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deNavigationBlockerReference &operator=( const deNavigationBlockerReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deNavigationBlocker *object ) const;
	bool operator!=( deNavigationBlocker *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deNavigationBlockerReference &reference ) const;
	bool operator!=( const deNavigationBlockerReference &reference ) const;
	/*@}*/
};
