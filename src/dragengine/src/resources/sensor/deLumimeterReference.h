...
#ifndef _DELUMIMETERREFERENCE_H_
#define _DELUMIMETERREFERENCE_H_
...
public:
	 ...
	 */
	deLumimeterReference( deLumimeter *object );
	 ...
	 */
	deLumimeterReference( const deLumimeterReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deLumimeter *object );
	 ...
	 */
	deLumimeterReference &operator=( deLumimeter *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deLumimeterReference &operator=( const deLumimeterReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deLumimeter *object ) const;
	bool operator!=( deLumimeter *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deLumimeterReference &reference ) const;
	bool operator!=( const deLumimeterReference &reference ) const;
	/*@}*/
};
