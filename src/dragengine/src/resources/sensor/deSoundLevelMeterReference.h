...
#ifndef _DESOUNDLEVELMETERREFERENCE_H_
#define _DESOUNDLEVELMETERREFERENCE_H_
...
/**
 * \brief Sound level meter reference.
 * 
 ...
 */
class DE_DLL_EXPORT deSoundLevelMeterReference : protected deObjectReference {
public:
	 ...
	 */
	deSoundLevelMeterReference( deSoundLevelMeter *object );
	 ...
	 */
	deSoundLevelMeterReference( const deSoundLevelMeterReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deSoundLevelMeter *object );
	...
	operator deSoundLevelMeter*() const;
	 ...
	 * \throws deeNullPointer if object is NULL.
	 */
	deSoundLevelMeter* operator->() const;
	 ...
	 */
	deSoundLevelMeterReference &operator=( deSoundLevelMeter *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deSoundLevelMeterReference &operator=( const deSoundLevelMeterReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deSoundLevelMeter *object ) const;
	bool operator!=( deSoundLevelMeter *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deSoundLevelMeterReference &reference ) const;
	bool operator!=( const deSoundLevelMeterReference &reference ) const;
	/*@}*/
};
