...
#ifndef _DETOUCHSENSORREFERENCE_H_
#define _DETOUCHSENSORREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deTouchSensorReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deTouchSensorReference();
	 ...
	 */
	deTouchSensorReference( deTouchSensor *object );
	 ...
	 */
	deTouchSensorReference( const deTouchSensorReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deTouchSensor *object );
	 ...
	 */
	deTouchSensorReference &operator=( deTouchSensor *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deTouchSensorReference &operator=( const deTouchSensorReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deTouchSensor *object ) const;
	bool operator!=( deTouchSensor *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deTouchSensorReference &reference ) const;
	bool operator!=( const deTouchSensorReference &reference ) const;
	/*@}*/
};
