...
#ifndef _DENETWORKVALUEREFERENCE_H_
#define _DENETWORKVALUEREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deNetworkValueReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deNetworkValueReference();
	 ...
	 */
	deNetworkValueReference( deNetworkValue *object );
	 ...
	 */
	deNetworkValueReference( const deNetworkValueReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deNetworkValue *object );
	 ...
	 */
	deNetworkValueReference &operator=( deNetworkValue *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deNetworkValueReference &operator=( const deNetworkValueReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deNetworkValue *object ) const;
	bool operator!=( deNetworkValue *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deNetworkValueReference &reference ) const;
	bool operator!=( const deNetworkValueReference &reference ) const;
	/*@}*/
};
