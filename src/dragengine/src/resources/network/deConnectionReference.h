...
#ifndef _DECONNECTIONREFERENCE_H_
#define _DECONNECTIONREFERENCE_H_
...
public:
	 ...
	 */
	deConnectionReference( deConnection *object );
	 ...
	 */
	deConnectionReference( const deConnectionReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deConnection *object );
	 ...
	 */
	deConnectionReference &operator=( deConnection *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deConnectionReference &operator=( const deConnectionReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deConnection *object ) const;
	bool operator!=( deConnection *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deConnectionReference &reference ) const;
	bool operator!=( const deConnectionReference &reference ) const;
	/*@}*/
};
