...
#ifndef _DEDEBUGDRAWERREFERENCE_H_
#define _DEDEBUGDRAWERREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deDebugDrawerReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deDebugDrawerReference();
	 ...
	 */
	deDebugDrawerReference( deDebugDrawer *object );
	 ...
	 */
	deDebugDrawerReference( const deDebugDrawerReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deDebugDrawer *object );
	 ...
	 */
	deDebugDrawerReference &operator=( deDebugDrawer *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deDebugDrawerReference &operator=( const deDebugDrawerReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deDebugDrawer *object ) const;
	bool operator!=( deDebugDrawer *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deDebugDrawerReference &reference ) const;
	bool operator!=( const deDebugDrawerReference &reference ) const;
	/*@}*/
};
