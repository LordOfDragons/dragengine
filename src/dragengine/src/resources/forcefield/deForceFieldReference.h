...
#ifndef _DEFORCEFIELDREFERENCE_H_
#define _DEFORCEFIELDREFERENCE_H_
...
public:
	 ...
	 */
	deForceFieldReference( deForceField *object );
	 ...
	 */
	deForceFieldReference( const deForceFieldReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deForceField *object );
	 ...
	 */
	deForceFieldReference &operator=( deForceField *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deForceFieldReference &operator=( const deForceFieldReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deForceField *object ) const;
	bool operator!=( deForceField *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deForceFieldReference &reference ) const;
	bool operator!=( const deForceFieldReference &reference ) const;
	/*@}*/
};
