...
#ifndef _DECOMPONENTREFERENCE_H_
#define _DECOMPONENTREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deComponentReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deComponentReference();
	 ...
	 */
	deComponentReference( deComponent *object );
	 ...
	 */
	deComponentReference( const deComponentReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deComponent *object );
	 ...
	 */
	deComponentReference &operator=( deComponent *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deComponentReference &operator=( const deComponentReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deComponent *object ) const;
	bool operator!=( deComponent *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deComponentReference &reference ) const;
	bool operator!=( const deComponentReference &reference ) const;
	/*@}*/
};
