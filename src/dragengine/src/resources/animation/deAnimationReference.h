...
#ifndef _DEANIMATIONREFERENCE_H_
#define _DEANIMATIONREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deAnimationReference : protected deObjectReference {
public:
	 ...
	 */
	deAnimationReference( deAnimation *object );
	 ...
	 */
	deAnimationReference( const deAnimationReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deAnimation *object );
	 ...
	 */
	deAnimationReference &operator=( deAnimation *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deAnimationReference &operator=( const deAnimationReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deAnimation *object ) const;
	bool operator!=( deAnimation *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deAnimationReference &reference ) const;
	bool operator!=( const deAnimationReference &reference ) const;
	/*@}*/
};
