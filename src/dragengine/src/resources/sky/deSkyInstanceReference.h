...
#ifndef _DESKYINSTANCEREFERENCE_H_
#define _DESKYINSTANCEREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT deSkyInstanceReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	deSkyInstanceReference();
	 ...
	 */
	deSkyInstanceReference( deSkyInstance *object );
	 ...
	 */
	deSkyInstanceReference( const deSkyInstanceReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deSkyInstance *object );
	 ...
	 */
	deSkyInstanceReference &operator=( deSkyInstance *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deSkyInstanceReference &operator=( const deSkyInstanceReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deSkyInstance *object ) const;
	bool operator!=( deSkyInstance *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deSkyInstanceReference &reference ) const;
	bool operator!=( const deSkyInstanceReference &reference ) const;
	/*@}*/
};
