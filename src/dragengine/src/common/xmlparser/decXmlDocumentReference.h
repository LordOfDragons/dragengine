...
#ifndef _DECXMLDOCUMENTREFERENCE_H_
#define _DECXMLDOCUMENTREFERENCE_H_
 ...
 */
class DE_DLL_EXPORT decXmlDocumentReference : protected deObjectReference {
public:
	/** \name Constructors and Destructors */
	/*@{*/
	/** \brief Create empty object reference holder. */
	decXmlDocumentReference();
	 ...
	 */
	decXmlDocumentReference( decXmlDocument *object );
	 ...
	 */
	decXmlDocumentReference( const decXmlDocumentReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( decXmlDocument *object );
	 ...
	 */
	decXmlDocumentReference &operator=( decXmlDocument *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	decXmlDocumentReference &operator=( const decXmlDocumentReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( decXmlDocument *object ) const;
	bool operator!=( decXmlDocument *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const decXmlDocumentReference &reference ) const;
	bool operator!=( const decXmlDocumentReference &reference ) const;
	/*@}*/
};
