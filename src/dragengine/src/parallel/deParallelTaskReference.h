...
#ifndef _DEPARALLELTASKREFERENCE_H_
#define _DEPARALLELTASKREFERENCE_H_
...
public:
	 ...
	 */
	deParallelTaskReference( deParallelTask *object );
	 ...
	 */
	deParallelTaskReference( const deParallelTaskReference &reference );
	/*@}*/
	 ...
	 */
	void TakeOver( deParallelTask *object );
	 ...
	 */
	deParallelTaskReference &operator=( deParallelTask *object );
	 ...
	 * stored. If the new object is not NULL a reference is added.
	 */
	deParallelTaskReference &operator=( const deParallelTaskReference &reference );
	
	/** \brief Test if object is held by this holder. */
	bool operator==( deParallelTask *object ) const;
	bool operator!=( deParallelTask *object ) const;
	
	/** \brief Test if object is held by this holder. */
	bool operator==( const deParallelTaskReference &reference ) const;
	bool operator!=( const deParallelTaskReference &reference ) const;
	/*@}*/
};
